...
public class CircularProgress: UIView, CAAnimationDelegate {
    ...
    public var currentCount:Double=0
    public var maxCount:Double=1
    
    func newAngle() -> Double {
        return 360 * (currentCount / maxCount)
    }
    @IBAction func increaseProgress(toValue value:Double) {
    ...
    @objc @IBInspectable public var IBColor1: UIColor?
    @objc @IBInspectable public var IBColor2: UIColor?
    @objc @IBInspectable public var IBColor3: UIColor?
